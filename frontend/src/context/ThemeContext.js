...
export const applyTheme = (settings = {}) => {
  ...
  const primaryDark =
    settings.primaryDarkColor || themeData.primaryDark;

  const primaryLight =
    settings.primaryLightColor || themeData.primaryLight;

  const accent =
    settings.secondaryColor || themeData.accent;

  const dark =
    settings.darkBgColor || themeData.dark;
...
/* =========================================
   LOAD THEME BEFORE REACT RENDER
========================================= */
...
export const ThemeProvider = ({
  ...
  /*
    useLayoutEffect prevents
    default theme flashing
  */
